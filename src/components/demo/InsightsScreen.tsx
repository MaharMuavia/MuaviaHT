    ...
    <div className="p-6 space-y-6 animate-in slide-in-from-right-4 duration-500">
      ...
      <div className="space-y-4">
        {analysisResults?.insights.map((insight, idx) => {
          ...
          return (
            <Card key={idx} className="glass-card overflow-hidden group hover:border-intel-blue/30 transition-all">
              <CardContent className="p-5 space-y-3">
                <div className="flex items-start justify-between">
                  <div className={cn("p-2 rounded-lg bg-secondary", insight.severity === 'Critical' && "bg-red-500/10")}>
                    <Icon className={cn("w-6 h-6", insight.severity === 'Critical' ? "text-red-500" : "text-intel-blue")} />
                  </div>
                ...
                <div className="space-y-1">
                  <h3 className="font-bold text-lg leading-tight group-hover:text-intel-blue transition-colors">
                    {insight.title}
                  </h3>
